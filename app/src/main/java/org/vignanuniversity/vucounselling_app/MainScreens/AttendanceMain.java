...
public class AttendanceMain extends AppCompatActivity implements OnScrollListener {
    ...
    static String regno = "", name = "",sphone = "", semail = "",pphone = "", pemail = "",pname = "",cyear="",sem="";
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (select){
                    case 0:
                        ...
                        break;
                    case 1:
                        Title = "Module - I Marks";
                        break;
                    case 2:
                        Title = "Module - II Marks";
                        break;
                }
            }
            @Override
    ...
    private void DisplaycontactInfo() {
        ...
        studentPhone.setOnClickListener(v -> {
            // make a call to the student phone number
        ...
        parentPhone.setOnClickListener(v -> {
            // make a call to the parent phone number
